...
$(call inherit-product, device/xiaomi/santoni/hidl/hidl.mk)
...
# Qualcomm
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/privapp-permissions-oem.xml:system/vendor/etc/permissions/privapp-permissions-oem.xml
